"""Ingest a CellxGene Census TileDB-SOMA store into a homeobox ragged atlas.
...
Usage:
    python -m homeobox_examples.cellxgene_census_tiledb.ingest \
...
def main():
    parser = argparse.ArgumentParser(
        description="Ingest CellxGene Census TileDB-SOMA store into a homeobox atlas"
    )
    parser.add_argument(
        "--soma-path",
        required=True,
