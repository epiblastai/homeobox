...
Usage:
    python -m homeobox_examples.cellxgene_census_tiledb.ingest_single_group \
...
def main():
    parser = argparse.ArgumentParser(
        description="Ingest CellxGene Census TileDB-SOMA into a single-group homeobox atlas"
    )
    parser.add_argument(
        "--soma-path",
        required=True,
