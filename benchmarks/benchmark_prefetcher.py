...
class PrefetcherTimingAnalyzer:
    ...
    def print_comprehensive_timing_table(self, all_results: dict[str, list[BatchTiming]]):
        ...
        if cells_per_sec_values:
            self.console.print(f"Best throughput: {int(max(cells_per_sec_values)):,} cells/sec")
            self.console.print(
