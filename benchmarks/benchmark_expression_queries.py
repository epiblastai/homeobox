...
def demo_realistic_expression_queries(h5ad_path: str, slaf_path: str, tiledb_path: str = None):
...
def _measure_tiledb_expression_query(tiledb_path: str, scenario: dict):
    ...
    try:
        ...
        result_size = result.shape[0] * result.shape[1] if hasattr(result, "shape") else 0
...
def benchmark_expression_query_scenario(
    ...
    result = {
        ...
        "h5ad_slaf_results_match": h5ad_result["result_size"] == slaf_result["result_size"],
        # Memory breakdown
