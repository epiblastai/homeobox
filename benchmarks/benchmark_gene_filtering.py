...
def demo_realistic_gene_queries():
    ...
    scenarios = [
        ...
        },
        {
            ...
            "h5ad_code": lambda adata: adata.var[
                (adata.var.n_cells_by_counts >= 5) & (adata.var.n_cells_by_counts <= 1000)
            ],
...
def _measure_tiledb_gene_filtering(tiledb_path: str, scenario: dict):
    ...
    try:
        ...
        var_table = experiment.ms["RNA"].var.read(value_filter=scenario["tiledb_filter"]).concat()
...
def benchmark_gene_filtering(
    ...
    for i, scenario in enumerate(scenarios):
        ...
        try:
            ...
            result = benchmark_gene_filtering_scenario(h5ad_path, slaf_path, tiledb_path, scenario)
