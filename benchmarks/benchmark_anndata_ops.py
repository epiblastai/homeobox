...
def _measure_slaf_anndata_op(slaf_path: str, scenario: dict):
    ...
    if scenario["type"] == "expression_slicing":
        ...
        if scenario["operation"] == "shape":
            ...
            nnz_result = slaf.query("SELECT COUNT(*) as nnz FROM expression WHERE value > 0")
...
def benchmark_anndata_ops(h5ad_path: str, slaf_path: str, include_memory=True, verbose=False):
