...
Stored in a single LanceDB at ``~/.cache/homeobox/reference_db/`` by default,
or at the path specified by the ``HOMEOBOX_REFERENCE_DB_PATH`` environment
...
REFERENCE_DB_PATH_ENV_VAR = "HOMEOBOX_ONTOLOGY_DB_PATH"
DEFAULT_REFERENCE_DB_PATH = os.environ.get(
    REFERENCE_DB_PATH_ENV_VAR,
    str(Path.home() / ".cache" / "homeobox" / "reference_db"),
)
