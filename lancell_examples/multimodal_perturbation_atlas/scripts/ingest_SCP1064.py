...
Prerequisites:
  - Prepared data in /tmp/geo_agent/SCP1064/ (from geo-data-preparer)
...
from lancell.ingestion import deduplicate_var
...
ACCESSION = "SCP1064"
ACCESSION_DIR = Path("/tmp/geo_agent/SCP1064")
...
def main() -> None:
    ...
    print(f"{'='*60}")
    n = ingest_experiment(atlas, publication_uid, metadata, args.limit)
